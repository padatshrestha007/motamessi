...
:project_id: gs-motamessi-webapi
...
You can use this https://start.spring.io/#!type=maven-project&language=java&platformVersion=2.5.5&packaging=jar&jvmVersion=11&groupId=com.example&artifactId=motamessi-webapi&name=motamessi-webapi&description=Demo%20project%20for%20Spring%20Boot&packageName=com.example.motamessi-webapi&dependencies=web[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
...
* https://spring.io/guides/gs/motamessi-webapi-angularjs/[Consuming a RESTful Web Service with AngularJS]
* https://spring.io/guides/gs/motamessi-webapi-jquery/[Consuming a RESTful Web Service with jQuery]
* https://spring.io/guides/gs/motamessi-webapi-restjs/[Consuming a RESTful Web Service with rest.js]
